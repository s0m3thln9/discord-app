const Input = ({ errors, register, id, type, label, placeholder, help, classes, required, pattern, minLength, maxLength, }) => {
	return (
		<div>
			{label &&
				<label
			...
			{register ?
				<input
					className={`outline-0 w-full h-10 p-2.5 mt-2 font-medium rounded-[0.1875rem] bg-[#1e1f22] text-[#dbdee1] peer ${classes}`}
