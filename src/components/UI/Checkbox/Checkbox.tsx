...
const Checkbox = ({ id, label, classes }: Props) => {
	return (
		<label
			className={`relative inline-flex cursor-pointer ${classes}`}
			htmlFor={id}
		>
			<input
