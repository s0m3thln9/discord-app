...
import addFriendImage from '../../../../../assets/img/addFriends.svg'
...
const AddingFriends = () => {
	...
	return (
		<div className={'flex grow flex-col'}>
			<div className={'h-fit border-b-[1px] border-b-[#3f4147] px-[1.875rem] py-5'}>
			...
			<div className={'flex grow flex-col items-center justify-center'}>
				<img src={addFriendImage} alt="addFriend" />
				<p className={'mt-8 text-[#949ba4]'}>Wumpus is waiting on friends. You don’t have to though!</p>
			</div>
		</div>
	)
}
