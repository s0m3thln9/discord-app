export const DSLogoText = ({ classes }: { classes: string }) => (
	<svg
		className={classes}
		fill="none"
		height="36"
	...
	>
		<g fill="#fff">
			...
			<path d="m115.438 14.5364v3.8642c-.455-.299-1.043-.4473-1.772-.4473-.952 0-1.689.2888-2.2.8665-.513.5775-.769 1.4771-.769 2.6936v3.2918h-4.383v-10.4656h4.294v3.3275c.237-1.2165.623-2.1135 1.155-2.6937.529-.5775 1.214-.8663 2.047-.8663.631 0 1.173.1431 1.628.4293z" />
			<path d="m130 11.9245v12.8806h-4.383v-2.3436c-.37.8818-.933 1.5539-1.689 2.0139-.757.4575-1.692.6875-2.802.6875-.991 0-1.855-.2402-2.593-.7232-.739-.4831-1.309-1.145-1.71-1.9858-.399-.8408-.601-1.7915-.601-2.8547-.012-1.0964.2-2.0803.636-2.9518.435-.8715 1.051-1.5513 1.843-2.0395.793-.4881 1.697-.7334 2.712-.7334 2.088 0 3.488.9072 4.204 2.7192v-4.6692zm-5.037 9.2413c.447-.4344.669-.9992.669-1.6893 0-.667-.217-1.2114-.651-1.628-.435-.4165-1.031-.6261-1.779-.6261-.739 0-1.329.2122-1.771.6364s-.662.9737-.662 1.6535.22 1.2344.662 1.6637c.442.4294 1.025.6441 1.753.6441.738-.0026 1.331-.2198 1.779-.6543z" />
			<path d="m62.0824 15.4539c1.2067 0 2.1853-.8787 2.1853-1.9627s-.9786-1.9628-2.1853-1.9628-2.1852.8788-2.1852 1.9628.9785 1.9627 2.1852 1.9627z" />
			<path d="m59.8953 16.806c1.3393.5776 3.0004.6032 4.3704 0v8.0555h-4.3704z" />
		</g>
	</svg>
)

export const DSLogo = ({ width = 27, height = 22, ...props }: { width?: number; height?: number }) => (
	<svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 27 22" fill="none" {...props}>
		<path
...
export const Compass = ({ ...props }) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
		<path d="M12 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z" className=""></path>
		<path
			fillRule="evenodd"
...
export const Headphones = ({ ...props }) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" {...props}>
		<path d="M12 3a9 9 0 0 0-8.95 10h1.87a5 5 0 0 1 4.1 2.13l1.37 1.97a3.1 3.1 0 0 1-.17 3.78 2.85 2.85 0 0 1-3.55.74 11 11 0 1 1 10.66 0c-1.27.71-2.73.23-3.55-.74a3.1 3.1 0 0 1-.17-3.78l1.38-1.97a5 5 0 0 1 4.1-2.13h1.86A9 9 0 0 0 12 3Z" />
	</svg>
)

export const HeadphonesOff = ({ ...props }) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" {...props}>
...
export const NewDMGroup = ({ ...props }) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" {...props}>
		<path d="M19 14a1 1 0 0 1 1 1v3h3a1 1 0 1 1 0 2h-3v3a1 1 0 1 1-2 0v-3h-3a1 1 0 1 1 0-2h3v-3a1 1 0 0 1 1-1Z"></path>
		<path d="M20.76 12.57c.4.3 1.23.13 1.24-.37V12a10 10 0 1 0-18.44 5.36c.12.19.1.44-.04.61l-2.07 2.37A1 1 0 0 0 2.2 22h10c.5-.01.67-.84.37-1.24A3 3 0 0 1 15 16h.5a.5.5 0 0 0 .5-.5V15a3 3 0 0 1 4.76-2.43Z"></path>
	</svg>
)
...
export const Message = ({ ...props }) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" {...props}>
		<path d="M12 22a10 10 0 1 0-8.45-4.64c.13.19.11.44-.04.61l-2.06 2.37A1 1 0 0 0 2.2 22H12Z" className=""></path>
	</svg>
)
...
export const Accept = ({ ...props }) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
		<path d="M21.7 5.3a1 1 0 0 1 0 1.4l-12 12a1 1 0 0 1-1.4 0l-6-6a1 1 0 1 1 1.4-1.4L9 16.58l11.3-11.3a1 1 0 0 1 1.4 0Z"></path>
	</svg>
)

export const RingingPhone = ({ ...props }) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" {...props}>
		<path d="M2 7.4A5.4 5.4 0 0 1 7.4 2c.36 0 .7.22.83.55l1.93 4.64a1 1 0 0 1-.43 1.25L7 10a8.52 8.52 0 0 0 7 7l1.12-2.24a1 1 0 0 1 1.19-.51l5.06 1.56c.38.11.63.46.63.85C22 19.6 19.6 22 16.66 22h-.37C8.39 22 2 15.6 2 7.71V7.4ZM13 3a1 1 0 0 1 1-1 8 8 0 0 1 8 8 1 1 0 1 1-2 0 6 6 0 0 0-6-6 1 1 0 0 1-1-1Z"></path>
		<path d="M13 7a1 1 0 0 1 1-1 4 4 0 0 1 4 4 1 1 0 1 1-2 0 2 2 0 0 0-2-2 1 1 0 0 1-1-1Z"></path>
	</svg>
)

export const Camera = ({ ...props }) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" {...props}>
		<path d="M4 4a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h11a3 3 0 0 0 3-3v-2.12a1 1 0 0 0 .55.9l3 1.5a1 1 0 0 0 1.45-.9V7.62a1 1 0 0 0-1.45-.9l-3 1.5a1 1 0 0 0-.55.9V7a3 3 0 0 0-3-3H4Z"></path>
	</svg>
)

export const Pin = ({ ...props }) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" {...props}>
		<path d="M19.38 11.38a3 3 0 0 0 4.24 0l.03-.03a.5.5 0 0 0 0-.7L13.35.35a.5.5 0 0 0-.7 0l-.03.03a3 3 0 0 0 0 4.24L13 5l-2.92 2.92-3.65-.34a2 2 0 0 0-1.6.58l-.62.63a1 1 0 0 0 0 1.42l9.58 9.58a1 1 0 0 0 1.42 0l.63-.63a2 2 0 0 0 .58-1.6l-.34-3.64L19 11l.38.38ZM9.07 17.07a.5.5 0 0 1-.08.77l-5.15 3.43a.5.5 0 0 1-.63-.06l-.42-.42a.5.5 0 0 1-.06-.63L6.16 15a.5.5 0 0 1 .77-.08l2.14 2.14Z"></path>
	</svg>
)
...
export const Present = ({ ...props }) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" {...props}>
		<path
			...
			clipRule="evenodd"
		></path>
		<path d="M3 20c0 1.1.9 2 2 2h5.5a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.5-.5h-7a.5.5 0 0 0-.5.5V20ZM13.5 22a.5.5 0 0 1-.5-.5v-7c0-.28.22-.5.5-.5h7c.28 0 .5.22.5.5V20a2 2 0 0 1-2 2h-5.5Z"></path>
	</svg>
)
...
export const Group = ({ ...props }) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 100 100" {...props}>
		<circle cx="37.692" cy="34.974" r="15.385" />
		<path d="M79.288,53H64.654C68.847,57,72,61.998,72,67.795V71h18v-7.308C90,57.801,85.18,53,79.288,53z" />
		<path d="M65,76v-8.205C65,61.026,59.846,55,53.077,55h-30.77C15.539,55,10,61.026,10,67.795V76H65z" />
		<path d="M65.897,21.736c-3.478,0-6.635,1.336-9.015,3.509c1.489,2.927,2.348,6.227,2.348,9.729c0,3.586-0.894,6.963-2.449,9.94  c2.392,2.229,5.59,3.602,9.116,3.602c7.396,0,13.391-5.993,13.391-13.39C79.288,27.731,73.293,21.736,65.897,21.736z" />
	</svg>
)
